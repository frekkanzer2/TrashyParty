...
public class LavaBallGenerator : MonoBehaviour
{
    ...
    IEnumerator GenLevel1(float spawnSecondsSpeed)
    {
        ...
        SpawnAndThrowLavaBall(new Vector2(39.37f, -5.14f), new Vector2(-100f, -5.14f));
    ...
    {
        yield return new WaitForSeconds(spawnSecondsSpeed);
        SpawnAndThrowLavaBall(new Vector2(39.37f, -3.26f), new Vector2(-100f, -3.26f));
    ...
    {
        yield return new WaitForSeconds(spawnSecondsSpeed);
        SpawnAndThrowLavaBall(new Vector2(39.37f, 22.57f), new Vector2(-39.37f*1.5f, -22.57f*1.5f));
        SpawnAndThrowLavaBall(new Vector2(-39.37f, 22.57f), new Vector2(39.37f * 1.5f, -22.57f * 1.5f));
    ...
    {
        yield return new WaitForSeconds(spawnSecondsSpeed);
        SpawnAndThrowLavaBall(new Vector2(-14f, -22.6f), new Vector2(-14f, 100f));
        SpawnAndThrowLavaBall(new Vector2(14f, -22.6f), new Vector2(14f, 100f));
        yield return new WaitForSeconds(1.5f);
        SpawnAndThrowLavaBall(new Vector2(-8f, -22.6f), new Vector2(-8f, 100f));
        SpawnAndThrowLavaBall(new Vector2(8f, -22.6f), new Vector2(8f, 100f));
    ...
    {
        yield return new WaitForSeconds(spawnSecondsSpeed);
        SpawnAndThrowLavaBall(new Vector2(-11f, -22.6f), new Vector2(-11f, 100f));
        SpawnAndThrowLavaBall(new Vector2(11f, -22.6f), new Vector2(11f, 100f));
        yield return new WaitForSeconds(2f);
        SpawnAndThrowLavaBall(new Vector2(-5f, -22.6f), new Vector2(-5f, 100f));
        SpawnAndThrowLavaBall(new Vector2(5f, -22.6f), new Vector2(5f, 100f));
    ...
    {
        yield return new WaitForSeconds(spawnSecondsSpeed);
        SpawnAndThrowLavaBall(new Vector2(39.37f, -8.92f), new Vector2(-100f, -8.92f));
